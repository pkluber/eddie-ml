...
parser.add_argument('charges', nargs=3, help='If using a custom dimer (i.e., not from SSI, S66, or IL), add list for [monomer1 charge, monomer2 charge, total charge].', type=int)
parser.add_argument('xyz_file', type=str, help='Name of XYZ file.')
...
if __name__ == "__main__":
    if args.custom_dimer:
        ...
        cube_utils.dimer_cube_difference(args.xyz_file, args.method, resolution=args.resolution,
